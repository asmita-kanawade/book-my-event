...
const redirectToBookings = () =>{
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem>
        <IconButton aria-label="bookings" color="inherit">
          <EventIcon/>
        </IconButton>
        <p>Bookings</p>
      </MenuItem>
      <MenuItem onClick={redirectToCreateEvent}>
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <Tooltip title="Home">
            ...
            <IconButton aria-label="bookings" color="inherit" onClick={redirectToBookings}>
              <EventIcon/>
            </IconButton>
            </Tooltip>
            <Tooltip title="Publish event">
            <IconButton aria-label="addNew" color="inherit" onClick={redirectToCreateEvent}>
